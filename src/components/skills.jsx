  ...
  return (
    <section id="skills" className="py-12 bg-white dark:bg-gray-900 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          className="relative rounded-lg p-6 sm:p-8 border border-gray-200 dark:border-gray-700"
        >
            ...
            {developmentSteps.map((step, index) => (
              <React.Fragment key={step.number}>
                <div className="flex flex-col items-center">
                  <div
                    className="w-24 h-24 rounded-full flex items-center justify-center bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white shadow-lg"
                  >
            ...
            {skills.map((skill) => (
              ...
              >
                <img
                  src={skill.icon}
                  alt={skill.name}
                  className={`w-12 h-12 mx-auto mb-2 ${skill.darkIcon ? "dark:invert" : ""}`}
                />
